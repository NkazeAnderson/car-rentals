...
function Home() {
  ...
  return (
    <>
      {/* hero */}
      <div className="h-[70dvh] w-full bg-slate-600/10">
        <ImageGallery
          images={[
            ...
            <Container fullHeight>
              <div className="flex items-center h-full space-x-6">
                <div className="flex-1 text-white space-y-2">
                  ...
                  <p>
                    From compact cars to spacious SUVs, we provide a wide range
                    of vehicles to make your travels comfortable and
                    hassle-free. Let your journey begin with Bon Voyages!
                  </p>
