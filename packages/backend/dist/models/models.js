...
const carMongooseSchema = (0, zod_mongoose_1.zodSchema)(appEntitiesSchemas[common_1.AppEntities.Car]);
const userMongooseSchema = (0, zod_mongoose_1.zodSchema)(appEntitiesSchemas[common_1.AppEntities.User]);
const orderMongooseSchema = (0, zod_mongoose_1.zodSchema)(appEntitiesSchemas[common_1.AppEntities.Order]);
